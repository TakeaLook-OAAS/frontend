            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-11 bg-white/10 border-white/10 text-white placeholder:text-white/40 focus:border-blue-500 focus:ring-blue-500" required
                  />
              </div>
            </div>
