...
export default function GuidePage() {
  return (
    <div style={{ position: "relative" }}>
      <div style={{ position: "absolute", top: 22, left: 36, zIndex: 2, display: "flex", alignItems: "center", gap: 10 }}>
        <span style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, color: "rgba(255,255,255,0.55)", letterSpacing: "0.14em" }}>GUIDE</span>
        <span style={{ color: "rgba(255,255,255,0.25)" }}>/</span>
        <span style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, color: "#fff", letterSpacing: "0.14em", fontWeight: 600 }}>GETTING STARTED</span>
      </div>
